...
/// <summary>
/// Well-known skeleton bone IDs of Mafia II's character rigs (reference data — used to pretty-print
/// bone hashes). Preserved verbatim from the vendored toolkit, including its historical typos.
/// </summary>
