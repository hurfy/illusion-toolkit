...
{
    /// <summary>Every known parameter/sampler code with its friendly name — read-only view for catalogs
    /// (e.g. offering the S-slots a material does not carry yet).</summary>
    public static IReadOnlyDictionary<string, string> All => _names;
